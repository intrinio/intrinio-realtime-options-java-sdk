...
There are millions of options contracts, each with their own feed of activity.  We highly encourage you to make your trade, quote and open interest handlers has short as possible so your app can handle the volume of activity options data has.
