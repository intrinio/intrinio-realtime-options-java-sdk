...
public class UnusualActivity{
	...
	private final UnusualActivityType type;
	private final UnusualActivitySentiment sentiment;
	...
	public UnusualActivity(String contract,
	...
	public UnusualActivityType getType(){return this.type;}
	public UnusualActivitySentiment getSentiment(){return this.sentiment;}
	public double getTotalValue(){return this.totalValue;}
	public long getTotalSize(){return this.totalSize;}
	public double getAveragePrice(){return this.averagePrice;}
	...
	public boolean equals(Object obj){
		...
		UnusualActivity other = (UnusualActivity) obj;
	...
	public int hashCode(){
		return contract.hashCode()
				^ this.type.hashCode()
				^ this.sentiment.hashCode()
				^ Double.hashCode(totalValue)
				^ Long.hashCode(totalSize)
				^ Double.hashCode(averagePrice)
				^ Double.hashCode(askPriceAtExecution)
				^ Double.hashCode(bidPriceAtExecution)
				^ Double.hashCode(underlyingPriceAtExecution)
				^ Double.hashCode(timestamp);
	}
